	...
	<body class="login">
		<div class="row">
			<div class="main-login col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
				...
				<a href="../index.php"><center><h2>Patient Login</h2></center></a>
				</div>
				...
				<div class="box-login">
					<form class="form-login" method="post">
						<fieldset>
							...
							<div class="form-actions">
								...
								<button type="submit" class="btn btn-primary pull-middle" name="submit">
					...
					<div class="copyright">
						</span><span class="text-bold text-uppercase"> © Healthify </span>.
					</div>
